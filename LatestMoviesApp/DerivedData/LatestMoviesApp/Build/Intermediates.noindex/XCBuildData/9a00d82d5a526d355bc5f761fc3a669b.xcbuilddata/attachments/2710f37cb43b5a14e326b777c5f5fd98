...
extension Foundation.Bundle {
    ...
    static let module: Bundle = {
        let bundleName = "swift-composable-architecture_ComposableArchitecture"
        ...
        fatalError("unable to find bundle named swift-composable-architecture_ComposableArchitecture")
    }()
}